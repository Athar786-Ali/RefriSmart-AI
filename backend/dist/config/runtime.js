...
export const cloudinaryOptimizeUrl = (rawUrl) => {
...
export const encodeCompatMetaInDescription = (description, meta) => {
...
export const decodeCompatMetaFromDescription = (description) => {
...
export const formatSlotLabel = (date) => date.toLocaleString("en-IN", {
    weekday: "short",
    day: "2-digit",
    month: "short",
    hour: "2-digit",
...
export const fallbackStructuredDiagnosis = (appliance, issue, language) => {
...
export const generateSuggestedSlots = (startDate) => {
    const now = new Date();
...
export const makeSimplePdfBuffer = (title, lines) => {
...
export const generateFallbackDiagnosis = (appliance, issue, language) => {
    const normalized = issue.toLowerCase();
