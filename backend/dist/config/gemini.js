...
export const geminiClients = rawKeys.map((key) => new GoogleGenAI({ apiKey: key }));
...
export const rotateKey = () => {
    ...
    console.log(`[Gemini] 🔄 Rotating key: slot ${prev + 1} → slot ${currentKeyIndex + 1} of ${geminiClients.length}`);
};
export const totalKeys = () => geminiClients.length;
