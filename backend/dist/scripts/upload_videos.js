...
async function main() {
    for (let i = 0; i < videos.length; i++) {
        const id = randomUUID();
        await prisma.$executeRawUnsafe('INSERT INTO "Gallery" ("id", "imageUrl", "mediaType", "caption") VALUES ($1, $2, $3, $4)', id, videos[i], "video", "On-site Field Report - Professional Service Showcase");
        console.log(`Uploaded video ${i + 1}`);
    }
}
main()
